<div id='head'>
    <a class='logo-lol-header' href='./index.php' style="background-image: url(<?php echo $assetsURL; ?>/Icon/League_of_Legends_icon.svg);"></a>
    <h3 class='lol-universe'>Universe</h3>
    <div id='border-nav' class='border-nav'>
        <ul id='nav' class='nav'>
            <li><a href='./champions.php'>CHAMPIONS</a>
                <div class='heading-border'></div>
            </li>
            <li><a href='./regions.php'>REGIONS</a>
                <div class='heading-border'></div>
            </li>
            <li class='nav-item'>
                <a>ALT UNIVERSE
            ...
            <li class='nav-item'>
                ...
                <ul class='subnav'>
                    <li><a href='https://www.leagueoflegends.com/en-us/?utm_medium=card1%2Bplayruneterra.com&utm_source=riotbar'>Riot Games</a></li>
